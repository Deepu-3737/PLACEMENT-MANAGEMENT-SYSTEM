...
<% 
String regdno=request.getParameter("t4");
//out.println(regdno);
...
try {
	...
	ResultSet rs1 = st.executeQuery("select count(*) from student where regdno='"+regdno+"'");
    if(!rs1.next()) {
    	 a = 0;
    }
     a=rs1.getInt("count(*)");
   ...
   ResultSet rs=st.executeQuery(sql);
	...
	out.println("<tr><th>S.no</th><th>Registration no</th><th>Name</th><th>company</th><th>package</th></tr>");
	 ...
	 /* if(regdno.equals(dregdno)) {
	        ...
	        out.println("<h3 align='center'>Incorrect registration number</h3>");
	    }
