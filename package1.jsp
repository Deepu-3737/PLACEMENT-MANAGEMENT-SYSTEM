...
<%
String pack=request.getParameter("t6");
//out.println(regdno);
...
try {
	...
	int sno=1;
	ResultSet rs1 = st.executeQuery("select count(*) from student where package='"+pack+"'");
    if(!rs1.next()) {
    	 a = 0;
    }
     a=rs1.getInt("count(*)");
     if(a!=0){
	     String sql="select * from student where package>='"+pack+"'";
	 ...
	 /* if(cmpname.equals(dregdno)) {
	    	...
	    	out.println("<h3 align='center'>enter package below 10 lakhs!!</h3>");
	    }
